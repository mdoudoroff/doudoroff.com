...
<p>Welcome to the <em>revised</em> comparison launched in November 2025, with a narrowed, stronger focus.</p>
<p>When I began the first comparison in 2016, there only only a few options—fewer than ten. Today, depending how you count,
...
perfectly fine, and perfectly adequate for many folks’ needs. On the other hand, they are not interesting in and of themselves,
...
<p>The new comparison focuses only on larger mixer modules, generally those with at least some CV control and/or six or more channels. There are some exceptions.
...
utility mixers (you can <a href="https://modulargrid.net/e/modules/browser?SearchName=stereo+mixer&SearchVendor=&SearchFunction=6&SearchSecondaryfunction=&SearchHeight=&SearchTe=&SearchTemethod=max&SearchBuildtype=&SearchLifecycle=&SearchSet=all&SearchMarketplace=&SearchIsmodeled=0&SearchShowothers=1&SearchShowpanel=1&order=hp&direction=desc">
find those on modulargrid</a> and most likely one of your favorite Eurorack brands offers one), no matrix mixers (I love them, but they are not what this is designed for), and fewer dusty corners.</p>
